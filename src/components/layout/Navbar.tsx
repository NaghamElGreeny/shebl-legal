...
export default function Navbar() {
  ...
  return (
    <nav
      className={`navBar fixed  md:flex-shrink-0 w-full z-50 md:px-8 px-4 max-w-screen-xl flex flex-wrap items-center justify-between mx-auto sm:p-4 p-0  ${
        scrolled ? "on-scroll" : ""
      } `}
    >
      ...
      <div className="iconsdiv flex md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse items-center">
        <Link href={"/contact-us"} className="md:block hidden">
